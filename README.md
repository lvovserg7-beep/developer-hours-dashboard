...
Вкладка **Доходы и расходы** собирается отдельно, по кнопке «Сформировать», без кэша часов. Выручка и закупки — проведённые документы организации «Аллсан Интеграция», расходы — по статьям движения денежных средств, закрытые часы в блоке «Справочно» — задачи со статусом Порядок ≥ 7.
