...
Тестовая версия (не для боевого): [v1.7.4-test](https://github.com/lvovserg7-beep/developer-hours-dashboard/releases/tag/v1.7.4-test) — файл `TESTING`. Клон: `git clone --branch v1.7.4-test …`. На боевую ставить только стабильный тег из `STABLE`.
